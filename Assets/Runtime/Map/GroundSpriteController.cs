...
public class GroundSpriteController : SpriteController
{
    private static Vector3Int CoverVector = new(1, 1, -2);

    private IsometricGridManager igm;
    private GridObject gridObject;
    private PerspectiveController perspectiveController;
    public float alphaMultiplier_perspectiveMode = 0.2f;
    ...
    {
        Vector3Int p = gridObject.CellPosition + CoverVector;
